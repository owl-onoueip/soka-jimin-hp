...
const memberRoles = [
    ...
    { name: "小川 としや", role: "議会改革特別委員会委員長", photo: "/images/members/ogawa.webp", color: "bg-purple-600", emoji: "🏛️" },
    { name: "しばの 勝利", role: "団員", photo: "/images/members/shibano.webp", color: "bg-green-600", emoji: "🌿" },
